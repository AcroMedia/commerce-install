...
const sections = {
  ...
  */
  drupalBase: {
    ...
    options: [
      ...
      },
      {
        ...
        location: locations.LOCATION_INTL,
        base: 'openedu',
        package_link: 'https://imagexmedia.com/openedu/',
        enabled: true,
      },
    ],
  },
    ...
    options: [
      {
        ...
        composer_package_version: '^1.0@beta',
        location: locations.LOCATION_INTL,
      ...
      },
      {
        ...
        composer_package_version: '^1.1',
        location: locations.LOCATION_INTL,
        package_link: 'https://www.drupal.org/project/commerce_square',
      },
      {
        title: 'Point of Sale (POS)',
        composer_package: 'drupal/commerce_pos',
        composer_package_version: '^2.0@RC',
        location: locations.LOCATION_INTL,
        package_link: 'https://www.drupal.org/project/commerce_pos',
      },
      {
        title: 'Moneris',
      ...
      //   composer_package_version: '^1.0@alpha',
      //   location: locations.LOCATION_ASIA,
  ...
  shipping: {
    ...
    options: [
      ...
      },
      {
        ...
        composer_package_version: '3.x-dev',
        location: locations.LOCATION_INTL,
  ...
  taxes: {
    ...
    options: [
      ...
      },
      {
        ...
        composer_package_version: '1.x-dev',
        location: locations.LOCATION_INTL,
        package_link: 'https://www.drupal.org/project/commerce_avatax',
      },
      {
        title: 'Quickbooks',
        image_src: '/static/gfx/taxlogos/qb_webconnect.png',
        description: '',
      ...
      },
      {
        ...
        description: 'Not yet available with Kickstart.',
        image_src: '/static/gfx/taxlogos/qbo.png',
  ...
  catalog: {
    ...
    options: [
      ...
      },
      {
        ...
        composer_package_version: '^5.0@alpha',
        location: locations.LOCATION_INTL,
      ...
      },
      {
        ...
        composer_package_version: '^3.0@alpha',
        location: locations.LOCATION_INTL,
  ...
  content: {
    ...
    description: 'The organization and housing of your site’s content, images and product details are the heart of your business. Drupal’s famous CMS is seamlessly connected to the Commerce toolbox and allows for the ultimate in productization and marketing. By default there is no default content, however, if you would like to migrate content from another source, choose the source here.',
    required: true,
    options: [
      {
        title: 'None',
      ...
      {
        title: 'WooCommerce',
        description: 'Migrate your content from an existing WooCommerce setup.',
        composer_package: 'drupal/commerce_migrate',
        composer_package_version: '^2.0@alpha',
        package_link: 'https://www.drupal.org/project/commerce_migrate',
        location: locations.LOCATION_INTL,
  ...
  build: {
    title: 'Build & Install',
    description: 'The download below will contain a composer.json file and some associated helper scripts. To install your site, simply extract the folder to wherever you want the site to be built and run "composer install". If you are not familiar with composer, see the Drupal.org documentation to get started',
